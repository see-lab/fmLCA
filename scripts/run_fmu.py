...
Usage:
    ...
    python scripts/run_fmu.py --fmu fmu/Grid_Ipcc_v1.0.0.fmu
    python scripts/run_fmu.py --start-time 0 --stop-time 3600 --step-size 60 --u0 100
    python scripts/run_fmu.py --mode cosim --system-fmu fmu/PV_System_WECC.fmu --lca-fmu fmu/PvWecc_Ipcc_v1.0.0.fmu
"""
...
DEFAULT_FMU = ROOT / "fmu" / "Example_Ipcc_v1.0.0.fmu"
