...
class DatabaseManager:
    ...
    def find_primary_database(self) -> Optional[str]:
        ...
        print("   python scripts/setup_brightway.py --name fmLCA --ecoinvent 3.12 --check")
        print()
        print("2. Import ecoinvent 3.12 cutoff:")
        print("   python scripts/setup_brightway.py --name fmLCA --ecoinvent 3.12 --system-model cutoff")
        print()
